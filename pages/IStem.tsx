      ...
      <section className="py-32 px-6 blueprint-grid">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <SmoothReveal delay={300}>
            <div className="bg-slate-50 p-16 rounded-[5rem] space-y-10 text-brand-indigo shadow-2xl h-full relative overflow-hidden group border border-slate-100 hover:border-brand-indigo/40 transition-all flex flex-col items-center text-center">
              <div className="absolute top-0 right-0 p-12 opacity-[0.03] pointer-events-none group-hover:scale-110 transition-transform duration-1000"><Terminal size={300} /></div>
              <div className="flex flex-col items-center gap-8">
              ...
              <div className="grid grid-cols-2 gap-6 w-full">
                {['Neural Compute', 'Data Research', 'Cloud Systems', 'Cyber Labs'].map(f => (
                  <div key={f} className="bg-white p-6 rounded-2xl border border-slate-100 text-[10px] font-black uppercase tracking-widest text-brand-indigo flex items-center justify-center gap-4 group-hover:border-brand-red/20 transition-all">
