...
const WhyQuantaNova: React.FC = () => {
  return (
    <div className="min-h-screen bg-white pb-20 pt-10">
      ...
      <section className="py-24 bg-slate-50 blueprint-major text-brand-indigo border-y border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              ...
              <SmoothReveal key={idx} delay={idx * 200}>
                <div className="bg-white p-12 rounded-[3.5rem] border border-slate-200 hover:border-brand-red/40 transition-all group shadow-2xl relative overflow-hidden h-full flex flex-col items-center text-center">
                  ...
                  <h3 className="text-2xl font-display font-bold text-brand-indigo mb-6 uppercase tracking-tight">{feature.title}</h3>
