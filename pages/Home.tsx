...
const FullscreenBackground: React.FC = () => {
  ...
  return (
    <div className="absolute inset-0 z-0 overflow-hidden bg-black">
      <Iridescence colorA={[0.89, 0.22, 0.24]} colorB={[0.14, 0.23, 0.49]} speed={0.1} className="opacity-20 z-10" />
      ...
      <div className="absolute inset-0 blueprint-grid pointer-events-none opacity-[0.03] z-20"></div>
    </div>
  );
};
        ...
        <div className="max-w-[1800px] mx-auto space-y-6 relative z-30 w-full px-6 flex flex-col items-center">
          <SmoothReveal delay={200}>
            <div className="space-y-4 text-center flex flex-col items-center">
              ...
              <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-display font-bold text-white uppercase tracking-tighter leading-[0.9] drop-shadow-2xl">
                EMPOWERING <br /> FUTURE <span className="text-brand-red">QUANTUM</span> <br /> LEADERS
              </h1>
              <div className="text-xs sm:text-base md:text-xl text-slate-100 font-medium max-w-3xl mx-auto leading-relaxed pt-6 tracking-widest uppercase opacity-90 h-12">
                <TextType 
