          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={`relative px-6 py-2 rounded-full text-[10px] font-black uppercase tracking-[0.15em] transition-all duration-300 ${
                  isActive ? 'text-brand-red bg-brand-red/5' : 'text-slate-500 hover:text-brand-indigo hover:bg-slate-100/50'
                }`}
              >
                {item.label}
              </Link>
